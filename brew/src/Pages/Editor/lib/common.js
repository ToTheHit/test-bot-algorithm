 ...
 */
export const samePosition = (p1, p2) => p1 && p2 &&
 ...
 */
export const nearby = (p1, p2, tolerance) => Math.abs(p1.x - p2.x) <= tolerance &&
 ...
 */
export const isPointOverFirstLinkSegment = (point, link) => isPointOverSegment(point, {
  A: link.getFirstPosition(),
 ...
 */
export const isPointOverLink = (point, link) => isPointOverFirstLinkSegment(point, link) ||
