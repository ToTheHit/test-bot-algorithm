...
* В файле index.html измените значения переменных `segmentCount = 1` и `isDevVersion = false`.
* В файле webpack.prod.js изменить переменную `page` на название Вашего репозитория
...
Обработку новых запросов необходимо добавлять в файл `Routes.js`, который находится в директории /ibds/src/.
